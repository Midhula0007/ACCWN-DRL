...
{
  std::cout<<"connectsocketcallbacks()";////getchar();
  NS_LOG_FUNCTION (this);
...
{
//  ofstream myfile1;
//  myfile.open("example123x.txt");
// myfile<<"Increasewindow() in tcprl.cc"<<endl;////getchar();
